...
import { updateGameSchema } from "@/features/games/validation/schemas"
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        <textarea
          ...
          className="w-full px-3 py-2 text-[13px] bg-pv-card text-pv-text border-[2px] border-pv-border rounded-pv-sm focus:outline-none focus:border-pv-primary transition-colors resize-none"
        />
